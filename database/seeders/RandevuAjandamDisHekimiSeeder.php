...
class RandevuAjandamDisHekimiSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ([
            ['baslik' => 'Diş Sağlığını Korumak İçin 5 Günlük Alışkanlık', 'icerik' => '<p>Düzenli fırçalama, diş ipi kullanımı, dengeli beslenme ve rutin kontroller ağız sağlığının temelini oluşturur.</p>'],
            ['baslik' => 'Diş Taşı Temizliği Neden Önemlidir?', 'icerik' => '<p>Profesyonel temizlik, diş eti sağlığını destekler ve günlük bakımın ulaşamadığı birikimlerin uzaklaştırılmasına yardımcı olur.</p>'],
            ['baslik' => 'Estetik Dolgu Hakkında Merak Edilenler', 'icerik' => '<p>Kompozit dolgular, uygun vakalarda diş rengiyle uyumlu ve doğal görünümlü bir restorasyon seçeneği sunar.</p>'],
        ] as $blog) {
