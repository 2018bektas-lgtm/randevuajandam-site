...
@section('icerik')
    ...
    <div class="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4 p-6 rounded-2xl bg-white border border-[#E5E7EB] shadow-sm">
        ...
        <div>
            ...
            @else
                <a href="{{ route('frontend.hekim.paket_sec', ['degistir' => 1]) }}" class="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold bg-[#FFF7ED] border border-[#FED7AA] text-[#92400e] transition-all shadow-sm">
                    🔒 PDF rapor (paket yükselt)
                </a>
            @endif
        </div>
    </div>
