...
@section('baslik', 'Branş Ekle - Randevu Ajandam')
@section('sayfa_baslik', 'Branş Ekle')
...
@section('icerik')
    ...
    <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-6 border-b border-[#E5E7EB]">
        <div>
            ...
            <p class="text-xs text-[#6B7280] mt-1.5 ml-4">Sistem için yeni bir uzmanlık alanı / branş oluşturun.</p>
        </div>
