...
@section('baslik', 'Yeni Yönetici Ekle - Randevu Ajandam')
    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-6 border-b border-[#E5E7EB]">
            <div>
                ...
                <p class="text-xs text-[#6B7280] mt-1.5 ml-4">Sistem ayarlarına erişebilecek yeni bir yönetici tanımlayın.</p>
            </div>
        ...
        <form action="{{ route('yonetim.yoneticiler.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <input type="email" name="e_posta" id="e_posta" value="{{ old('e_posta') }}" placeholder="ahmet@randevuajandam.com" required
                    class="w-full px-4 py-3 rounded-xl bg-white border border-[#E5E7EB] text-[#111827] placeholder-gray-400 focus:outline-none focus:border-[#C96A2B] focus:ring-1 focus:ring-[#C96A2B] text-sm transition-all duration-200">
            </div>
            ...
            <div>
                ...
                <input type="text" name="telefon" id="telefon" value="{{ old('telefon') }}" placeholder="0 (5XX) XXX XX XX"
                    class="w-full px-4 py-3 rounded-xl bg-white border border-[#E5E7EB] text-[#111827] placeholder-gray-400 focus:outline-none focus:border-[#C96A2B] focus:ring-1 focus:ring-[#C96A2B] text-sm transition-all duration-200">
            </div>

            <!-- Password -->
            <div>
                <label for="sifre" class="block text-xs font-bold text-[#1F2937] uppercase tracking-wider mb-2 font-display">Şifre</label>
                <input type="password" name="sifre" id="sifre" placeholder="••••••••" required
                    class="w-full px-4 py-3 rounded-xl bg-white border border-[#E5E7EB] text-[#111827] placeholder-gray-400 focus:outline-none focus:border-[#C96A2B] focus:ring-1 focus:ring-[#C96A2B] text-sm transition-all duration-200">
                <span class="block text-[11px] text-[#6B7280] mt-1.5">Şifre en az 6 karakterden oluşmalıdır.</span>
            </div>
            ...
            <div class="flex items-center justify-between p-4.5 bg-slate-50/50 border border-[#E5E7EB] rounded-xl">
                <div>
                    ...
                    <span class="block text-[11px] text-[#6B7280] mt-0.5">Yöneticinin sisteme giriş izni aktif olsun mu?</span>
                </div>
