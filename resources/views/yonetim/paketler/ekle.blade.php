                ...
                <div id="clinicFields" class="hidden space-y-6 p-6 border border-[#E5E7EB] rounded-2xl bg-[#FFF7ED]/30">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
                        <div>
                            ...
                            <input type="number" name="ek_doktor_aylik_fiyat" id="ek_doktor_aylik_fiyat" value="{{ old('ek_doktor_aylik_fiyat') }}" step="0.01" min="0" placeholder="1000.00"
                                class="w-full px-4 py-2.5 rounded-xl bg-white border border-[#E5E7EB] text-[#111827] focus:outline-none focus:border-[#C96A2B] focus:ring-1 focus:ring-[#C96A2B] text-xs transition-all duration-200">
                        ...
                        <div>
                            ...
                            <input type="number" name="ek_doktor_yillik_fiyat" id="ek_doktor_yillik_fiyat" value="{{ old('ek_doktor_yillik_fiyat') }}" step="0.01" min="0" placeholder="10000.00"
                                class="w-full px-4 py-2.5 rounded-xl bg-white border border-[#E5E7EB] text-[#111827] focus:outline-none focus:border-[#C96A2B] focus:ring-1 focus:ring-[#C96A2B] text-xs transition-all duration-200">
