...
@component('frontend.legal._layout', [
    ...
    'ozet' => 'PayTR sanal POS / abonelik şartları kapsamında siteden erişilebilir unvan, yurt içi adres, telefon ve e-posta bilgileri.',
    'sections' => $sections,
])
    ...
    <p>
        ...
        doğrudan erişilebilir durumdadır (ödeme kuruluşu mağaza şartları).
    </p>
    @include('frontend.layouts.partials.company-identity')

    <h2 id="destek">2. Destek konuları</h2>
    <ul>
        <li>Hekim / klinik abonelik, deneme, paket değişimi ve ödeme</li>
        <li>Havale bildirimi ve üyelik aktivasyonu</li>
        <li>Randevu ve panel kullanımı</li>
        <li>Web sitesi / domain kurulumu</li>
        <li>Fatura bilgisi güncelleme (ödeme kaydı / manuel fatura)</li>
    ...
    <ul>
        ...
        <li><a href="{{ route('frontend.legal.hakkimizda') }}">Hakkımızda</a></li>
    </ul>
