...
class SifreSifirlamaLinkBildirimi extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->line('Mobil uygulamadan sıfırlıyorsanız: Giriş → Şifremi unuttum → “E-postadaki kod ile şifre belirle” adımında e-posta adresinizi ve aşağıdaki kodu kullanın:')
            ->line($this->token)
            ->line('Bu şifre sıfırlama linki/kodu 60 dakika boyunca geçerlidir.')
